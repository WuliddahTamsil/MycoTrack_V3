                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="relative animate-fade-in-up">
                        ...
                        <div className={`relative ${statusColor} ${statusBorderColor} border-2 rounded-full p-1.5 shadow-2xl transform transition-all duration-300 hover:scale-125 hover:z-30 hover:shadow-3xl`}>
                          {/* 3D Petani SVG Icon */}
                          <svg
                            width="40"
                            height="40"
                          ...
                          >
                            <defs>
                              ...
                              <filter id={`shadow-${marker.id}`}>
                                <feDropShadow dx="0" dy="2" stdDeviation="2" floodColor="#000000" floodOpacity="0.3"/>
                              </filter>
                            </defs>
                            
                            {/* Head with 3D effect */}
                            <circle cx="20" cy="12" r="6" fill="#F4A460" stroke="#8B4513" strokeWidth="2" filter={`url(#shadow-${marker.id})`} />
                            <circle cx="17" cy="11" r="1.5" fill="#000" />
                            <circle cx="23" cy="11" r="1.5" fill="#000" />
                            <path d="M 16 14 Q 20 15 24 14" stroke="#8B4513" strokeWidth="2" fill="none" strokeLinecap="round" />
                            
                            {/* Hat (Topi Petani) - 3D */}
                            <ellipse cx="20" cy="8" rx="7" ry="4" fill="#8B4513" filter={`url(#shadow-${marker.id})`} />
                            <ellipse cx="20" cy="7" rx="6" ry="3" fill="#A0522D" />
                            <ellipse cx="20" cy="6.5" rx="5" ry="2" fill="#654321" opacity="0.5" />
                            
                            {/* Body with 3D shading */}
                            <rect x="15" y="18" width="10" height="12" rx="2" fill="#4A90E2" filter={`url(#shadow-${marker.id})`} />
                            <rect x="15" y="18" width="10" height="12" rx="2" fill={`url(#gradient-${marker.id})`} />
                            <rect x="15" y="18" width="3" height="12" rx="1" fill="#3A7BC8" opacity="0.6" />
                            
                            {/* Arms */}
                            <rect x="10" y="20" width="5" height="10" rx="2" fill="#F4A460" filter={`url(#shadow-${marker.id})`} />
                            <rect x="25" y="20" width="5" height="10" rx="2" fill="#F4A460" filter={`url(#shadow-${marker.id})`} />
                            
                            {/* Legs */}
                            <rect x="16" y="30" width="4" height="8" rx="1" fill="#654321" filter={`url(#shadow-${marker.id})`} />
                            <rect x="20" y="30" width="4" height="8" rx="1" fill="#654321" filter={`url(#shadow-${marker.id})`} />
                            
                            {/* Tool (Cangkul) - 3D */}
                            <line x1="27" y1="23" x2="32" y2="18" stroke="#8B4513" strokeWidth="2.5" strokeLinecap="round" filter={`url(#shadow-${marker.id})`} />
                            <line x1="32" y1="18" x2="35" y2="15" stroke="#654321" strokeWidth="2" strokeLinecap="round" />
                            <circle cx="35" cy="15" r="1.5" fill="#654321" />
                          </svg>
                        </div>
