...
export const AdminHome: React.FC<AdminHomeProps> = ({ onNavigate }) => {
  ...
  const totalSystemBalance = totalCustomerBalance + totalFarmerBalance;
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <h2 className="text-xl font-bold text-[#2D2416] mb-4 flex items-center gap-2">
          <DollarSign className="h-6 w-6 text-[#FF7A00]" />
          Ringkasan Saldo Sistem
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="border-2 border-blue-200 bg-gradient-to-br from-blue-50 to-white shadow-md hover:shadow-lg transition-shadow">
            <CardContent className="p-6">
              <div className="flex items-center justify-between mb-2">
                <div>
                  <p className="text-sm text-gray-600 font-medium mb-1">Total Saldo Customer</p>
                  <p className="text-3xl font-bold text-blue-700">Rp {totalCustomerBalance.toLocaleString('id-ID')}</p>
                  <p className="text-xs text-gray-500 mt-1">{totalCustomers} customer aktif</p>
                </div>
          ...
          <Card className="border-2 border-green-200 bg-gradient-to-br from-green-50 to-white shadow-md hover:shadow-lg transition-shadow">
            <CardContent className="p-6">
              <div className="flex items-center justify-between mb-2">
                <div>
                  <p className="text-sm text-gray-600 font-medium mb-1">Total Saldo Petani</p>
                  <p className="text-3xl font-bold text-green-700">Rp {totalFarmerBalance.toLocaleString('id-ID')}</p>
                  <p className="text-xs text-gray-500 mt-1">{totalFarmers} petani aktif</p>
                </div>
          ...
          <Card className="border-2 border-purple-200 bg-gradient-to-br from-purple-50 to-white shadow-md hover:shadow-lg transition-shadow">
            <CardContent className="p-6">
              <div className="flex items-center justify-between mb-2">
                <div>
                  <p className="text-sm text-gray-600 font-medium mb-1">Total Saldo Sistem</p>
                  <p className="text-3xl font-bold text-purple-700">Rp {totalSystemBalance.toLocaleString('id-ID')}</p>
                  <p className="text-xs text-gray-500 mt-1">Semua saldo terkelola</p>
                </div>
