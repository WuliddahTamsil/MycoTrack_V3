...
export const CheckoutPage: React.FC = () => {
  ...
  const processPayment = async () => {
    ...
    try {
      ...
      // Balance deduction is handled by backend atomic transaction when payment status is updated
      ...
      for (const order of allOrders) {
        ...
        // Notification is already created by backend when order is created
      }
